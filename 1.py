...
print(today)
print(f"Проверка правильности введённой даты: {Data.valid(11, 11, 2021)}")
print(f"Проверка правильности введённой даты: {today.valid(11, 13, 2011)}")
print(Data.extract('11 - 1 - 2021'))
